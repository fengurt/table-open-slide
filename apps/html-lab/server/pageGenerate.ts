...
function buildPrompt(theme: ThemeId, title: string, content: string): string {
  ...
  return [
    ...
    '- Use semantic sections, strong typography, visible hierarchy, and responsive CSS.',
    '- Use diagrams, metric cards, timelines, comparison grids, or process blocks when useful.',
